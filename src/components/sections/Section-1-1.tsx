...
export default function Section_1_1({sectionData}: SectionProps) {
    return (
        <Lesson quiz={<Quiz_1_1 />} title="Einleitung" pages="A1/B1-A16/B29">
            <LessonListEl paragraphId={sectionData.lessonId + "-1"}>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-2"}>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-3"} pageNumber="B1">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-4"} isQuestion>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-5"} pageNumber="B2" isQuestion>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-6"}>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-7"} pageNumber="B2f.">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-8"} pageNumber="B3-6">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-9"} pageNumber="A6f./B10f.">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-10"} isQuestion>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-11"} pageNumber="A9f./B12-14" isQuestion>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-12"} pageNumber="B14-17">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-13"} pageNumber="A10ff./B24ff.">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-14"} pageNumber="A11/B24">
                <em>„Inbegriff“</em> = Gesamtheit (aller Vorstellungen, aller Gegenstände, etc.)
            </LessonListEl>
            <LessonListEl paragraphId={sectionData.lessonId + "-15"} pageNumber="A11/B24f.">
