...
export default function Section_1_1({sectionData}: SectionProps) {
    return (
        ...
        >
            ...
            <LessonListEl pageNumber="A6f./B10f.">
            ...
            <LessonListEl pageNumber="A9f./B12-14">
            ...
            <LessonListEl pageNumber="B14-17">
            ...
            <LessonListEl pageNumber="A10ff./B24ff.">
            ...
            <LessonListEl pageNumber="A11/B24">„Inbegriff“ = Gesamtheit (aller Vorstellungen, aller Gegenstände, etc.)
            </LessonListEl>
            <LessonListEl pageNumber="A11/B24f.">
