...
export default function Lesson_2_1({ sectionData }: SectionProps) {
    return (
        <Lesson quiz={<Quiz_2_1 />} title="Transzendentale Ästhetik, § 1" pages="A19/B33-A22/B36">
            <LessonListEl paragraphId={sectionData.lessonId + "-1"} pageNumber="A19/B33">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-3"} pageNumber="A19f./B34">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-4"}>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-5"} isQuestion>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-7"}>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-8"} pageNumber="A20/B34">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-9"}>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-11"} pageNumber="A20f./B34f.">
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-12"} isQuestion>
            ...
            <LessonListEl paragraphId={sectionData.lessonId + "-13"} pageNumber="A21f./B35f.">
